...
//            view.frame.origin.y = -keyboardRect.height
            view.window?.frame.origin.y = -keyboardRect.height
            
//            topLayout.constant = keyboardRect.height
//            bottomLayout.constant = keyboardRect.height
        } else {
//            view.frame.origin.y = 0

            // Option 1: move windows containing view
                        view.window?.frame.origin.y = 0
            
            // Option 2: move both outside constraints (more complex)
